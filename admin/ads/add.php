...
$pageTitle = 'Añadir Anuncio - Panel de Administración';
$currentMenu = 'ads_add';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || !verifyCsrfToken($_POST['csrf_token'])) {
        ...
        if (empty($errors)) {
            ...
            // Insertar anuncio
            $inserted = $db->query(
                "INSERT INTO ads (title, description, image, url, position, sector, start_date, end_date, status, priority, created_at)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())",
                [
                    $formData['title'],
            ...
            if ($inserted) {
                ...
                // Registrar acción
                logAdminAction('Anuncio creado', 'Título: ' . $formData['title'], 'ads', $adId);
                
                // Mostrar mensaje de éxito
                setFlashMessage('success', 'Anuncio creado correctamente');
                
                // Redireccionar a la página de anuncios
                redirect('index.php');
                exit;
            } else {
                $errors[] = 'Error al guardar el anuncio. Intenta nuevamente.';
            }
        }
    }
}
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Añadir Anuncio</h1>
                </div>
                <div class="col-sm-6">
